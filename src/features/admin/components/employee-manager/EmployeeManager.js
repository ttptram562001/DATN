...
const EmployeeManager = () => {
  ...
  const handleUpdateOk = () => {
    userApi
      .EmployeeToUser(modelCurrentAction.id)
      .then((response) => {
        if (response.data != null) {
          ...
          setSuccessStatus("Cannot get to update employee", response.data.message);
      })
      .catch((error) => {
        console.log(error);
  ...
  return (
    <>
      ...
      >
        <p>ARE YOU SURE TO CHANGE {username} INTO USER'S ROLE</p>
        <div class="form-group">
